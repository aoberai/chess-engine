...
second_hidden_dense = tf.keras.layers.Dense(units=64, activation='relu')(first_dense)
# dropout = tf.keras.layers.Dropout(0.2)(second_hidden_dense)
output_dense = tf.keras.layers.Dense(units=output_nodes, activation='sigmoid')(second_hidden_dense)
